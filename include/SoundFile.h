...
namespace InteractiveTango {
    ...
    protected:
        ...
        std::shared_ptr<std::vector<int>> harmonySectionProfile; //what kind of harmony section does this have?
    ...
    public:
        SoundFile(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile, int trackNum, int clipNum, int aid, double length=4, float slen=1, long fID=0, std::string filename="", int ord=1) //default one measure length for now
        {
            moodProfile = profile;
        ...
        std::shared_ptr<std::vector<int>> getProfile()
        {
            return moodProfile;
        };
        
        std::shared_ptr<std::vector<int>> getHarmonySectionProfile()
        {
    ...
    public:
        SoundFileBank()
        {};
        SoundFileBank(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile)
        {
            setProfiles(profile, hsProfile);
        };
        
        std::shared_ptr<std::vector<int>> getProfile(){ return moodProfile; };
        std::shared_ptr<std::vector<int>> getHSProfile(){ return harmonySectionProfile; };
        size_t size(){ return soundFiles.size(); };
        
        void setProfiles(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile)
        {
            moodProfile = profile;
            harmonySectionProfile = hsProfile;
        };
        ...
        SoundFile *findASound(Orchestra *orchestration, std::shared_ptr<std::vector<float>> profile_)
        {
        ...
        SoundFile *findASound( std::shared_ptr<std::vector<float>> profile_ )
        {
        ...
        bool generalProfileFit(std::shared_ptr<std::vector<int>>  p1, std::shared_ptr<std::vector<int>>  p2)
        {
            bool fits = true;
            int index = 0;
        ...
        virtual bool fitsProfile(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile)
        {
            bool fits;
    ...
    public:
        ...
        SoundFile *getFileFittingProfile( std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsprofile, Orchestra *orch, std::shared_ptr<std::vector<float>> orchProfile )
        {
            bool found = false;
            int index = 0;
        ...
        SoundFile *getFileFittingProfile( std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsprofile, Orchestra *orch )
        {
            bool found = false;
            int index = 0;
        ...
        SoundFile *getFileFittingProfileForPhraseStart(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsprofile, std::shared_ptr<std::vector<float>> instrumentProfile=NULL )
...
//            }
        ...
        //this is not for only phrase start -- phrase start for orch but also handles continuing melodies... whoops... refactor later
        SoundFile *getFileFittingProfileForPhraseStart(std::shared_ptr<std::vector<int>> hsprofile, std::shared_ptr<std::vector<int>> profile, Orchestra *orch, std::shared_ptr<std::vector<float>> instrumentProfile )
        //if hsprofile is empty --> this then is prob. melody or what-have-you but it doesn't matter what the harmony or structure is now -- could add structures later
        {
            bool found = false;
            int index = 0;
    ...
    public:
        StructuredSoundFile(SoundFileBanks *nextSound, std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile, int trackNum, int clipNum, int aid, double length=4, double slen=0, long fID=1,  std::string filename="", int ord=1) :
        ...
        SoundFile *getNextSound(std::shared_ptr<std::vector<int>> hsprofile, std::shared_ptr<std::vector<int>> profile)
        {
...
//            }
    ...
    public:
        MelodySoundFile(SoundFileBanks *nextSound, std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile, int trackNum, int clipNum, int aid, double length=4, double slen=0, int startHarmony=1, int endHarmony=1, long fID=1,  std::string filename="", int ord=1, int instrumentID=1, Instruments *ins=NULL) :
        ...
        SoundFile *getNextSound(std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsprofile)
        {
    ...
    public:
        AccompanimentSoundFile(SoundFileBanks *nextSound, std::shared_ptr<std::vector<int>> profile, std::shared_ptr<std::vector<int>> hsProfile, double length=4, double slen=0, long fID=1,  std::string filename="", int ord = 1 ) :
        ...
        SoundFile *getNextSound(std::shared_ptr<std::vector<int>> hsprofile, std::shared_ptr<std::vector<int>> profile, Orchestra *orch, std::shared_ptr<std::vector<float>> orchProfile)
        {
            if(nextSoundBit == NULL){
                if( order < 9 ) abort();
                return NULL;
