...
namespace InteractiveTango {
    ...
    public:
        ...
        SoundFile *findASound(Orchestra *orchestration, boost::shared_ptr<std::vector<float>> profile_)
        {
        ...
        SoundFile *findASound( boost::shared_ptr<std::vector<float>> profile_ )
        {
    ...
    public:
        ...
        SoundFile *getFileFittingProfile( boost::shared_ptr<std::vector<int>> profile, boost::shared_ptr<std::vector<int>> hsprofile, Orchestra *orch, boost::shared_ptr<std::vector<float>> orchProfile )
        {
            bool found = false;
            int index = 0;
        ...
        SoundFile *getFileFittingProfileForPhraseStart(boost::shared_ptr<std::vector<int>> profile, boost::shared_ptr<std::vector<int>> hsprofile, boost::shared_ptr<std::vector<float>> instrumentProfile=NULL )
...
//            }
        ...
        //this is not for only phrase start -- phrase start for orch but also handles continuing melodies... whoops... refactor later
        SoundFile *getFileFittingProfileForPhraseStart(boost::shared_ptr<std::vector<int>> hsprofile, boost::shared_ptr<std::vector<int>> profile, Orchestra *orch, boost::shared_ptr<std::vector<float>> instrumentProfile )
        //if hsprofile is empty --> this then is prob. melody or what-have-you but it doesn't matter what the harmony or structure is now -- could add structures later
        {
            bool found = false;
            int index = 0;
...
//            }
    ...
    public:
        ...
        SoundFile *getNextSound(boost::shared_ptr<std::vector<int>> hsprofile, boost::shared_ptr<std::vector<int>> profile, Orchestra *orch, boost::shared_ptr<std::vector<float>> orchProfile)
        {
            if(nextSoundBit == NULL){
                if( order < 9 ) abort();
                return NULL;
