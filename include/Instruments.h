...
public:
    ...
    //FOR NOW!
    bool fitsProfile( boost::shared_ptr<std::vector<float>> profile_, bool fudgeMiddleIfOnlyOneInstrument = true, int minP = 1, int maxP = 3 )
    {
    ...
    bool fitsProfileExcludingTHESEInstruments(Orchestra *orch, boost::shared_ptr<std::vector<float>> profile_, bool fudgeMiddleIfOnlyOneInstrument = true, int minP = 1, int maxP = 3  )
    {
        assert( profile_->size() == profile.size() );
        bool fits = true;
...
public:
    ...
    std::vector<int> instrumentsWithProfile( boost::shared_ptr<std::vector<float>> profile_ )
    {
    ...
    Orchestra orchestraWithProfile( boost::shared_ptr<std::vector<float>> profile_ )
    {
        Orchestra orch;
    ...
    Orchestra orchestraWithProfileKeepOne( boost::shared_ptr<std::vector<float>> profile_, int instrSize,
    ...
    //TODO: create an orchestra of a specific size.... using different instruments...
    //TODO: profile is also only 1
    Orchestra orchestraWithProfile( boost::shared_ptr<std::vector<float>> profile_, int instrSize,
                                   OrchestralEvent *orchPerceptualEvent,
                                   Orchestra *startOrch=NULL) //for adding to an existing orchestra
    {
