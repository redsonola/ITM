...
//        {
//            if ( msg.getArgType(i) == ci::osc::ArgType::INTEGER_32 )
//            {
//                append(msg.getArgInt32(i));
//            }
//            else if ( msg.getArgType(i) ==  ci::osc::ArgType::FLOAT )
//            {
//                append(msg.getArgFloat(i));
//            }
//            else if ( msg.getArgType(i) == ci::osc::ArgType::STRING )
//            {
//                addStringArg(msg.getArgString(i));
//            }
//            else if ( msg.getArgType(i) == ci::osc::ArgType::DOUBLE )
//            {
//                addStringArg(msg.getArgDouble(i));
//            }
//        }
//    };
//
...
//        {
//            if ( getArgType(i) == ci::osc::ArgType::INTEGER_32  )
//            {
//                ss << getArgInt32(i)<<",";
//            }
//            else if ( getArgType(i) ==  ci::osc::ArgType::FLOAT )
//            {
//                ss << getArgFloat(i)<<",";
//            }
//            else if ( getArgType(i) ==  ci::osc::ArgType::DOUBLE )
//            {
//                ss << getArgAsDouble(i)<<",";
//            }
...
//            {
//                    msg.append(getArgInt32(i));
//            }
//            else if ( getArgType(i) ==  cinder::osc::TYPE_FLOAT )
//            {
//                    msg.append(getArgFloat(i));
//            }
//            else if ( cinder::osc::TYPE_STRING )
//            {
