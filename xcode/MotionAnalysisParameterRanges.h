...
public:
    SectionASongFollowerParams()
    {
//        windowedVarCoEfficients = {0, 1.0}; //previous
//        windowedVarCoEfficients = {1.2, 1.65}; //trying to adjust for machine tango takes??
        
        windowedVarCoEfficients = {0, 0.5};
...
public:
    ...
    {
        windowedVarCoEfficients = {0, 0.45};
        footOnsetCoEfficients = {0.0, 0.45};
        windowedDiffVarCoEfficients = {0.0, 0.028};
        crossCoVarCoEfficients = {0.0, 0.1};
