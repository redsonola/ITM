...
//TODO -- have sensor specific sample rate in the sensor data class.
...
public:
    ...
    virtual std::vector<MidiMessage *> getMIDI(){  std::vector<MidiMessage *> msgs; return msgs;};
...
//        msg.append(atoi(port2.c_str()));
//        msg.setAddress(SHIMMER_CROSS_COVARIATION);
//        msg.append(curPeak);
//        msg.append(curPeakModVariance);
